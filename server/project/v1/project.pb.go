...
var file_project_v1_project_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_project_v1_project_proto_goTypes = []any{
	...
	(*CreateProjectRequest)(nil),          // 4: project.v1.CreateProjectRequest
	(*CreateProjectResponse)(nil),         // 5: project.v1.CreateProjectResponse
	...
	(*GetProjectsRequest)(nil),            // 10: project.v1.GetProjectsRequest
	(*GetProjectsResponse)(nil),           // 11: project.v1.GetProjectsResponse
	(*GetProjectsByCustomerRequest)(nil),  // 12: project.v1.GetProjectsByCustomerRequest
	(*GetProjectsByCustomerResponse)(nil), // 13: project.v1.GetProjectsByCustomerResponse
}
var file_project_v1_project_proto_depIdxs = []int32{
	...
	0,  // 3: project.v1.UpdateProjectRequest.project:type_name -> project.v1.Project
	...
	4,  // 8: project.v1.ProjectService.CreateProject:input_type -> project.v1.CreateProjectRequest
	6,  // 9: project.v1.ProjectService.UpdateProject:input_type -> project.v1.UpdateProjectRequest
	8,  // 10: project.v1.ProjectService.DeleteProject:input_type -> project.v1.DeleteProjectRequest
	10, // 11: project.v1.ProjectService.GetProjects:input_type -> project.v1.GetProjectsRequest
	12, // 12: project.v1.ProjectService.GetProjectsByCustomer:input_type -> project.v1.GetProjectsByCustomerRequest
	2,  // 13: project.v1.ProjectService.GetProject:output_type -> project.v1.GetProjectResponse
	5,  // 14: project.v1.ProjectService.CreateProject:output_type -> project.v1.CreateProjectResponse
	7,  // 15: project.v1.ProjectService.UpdateProject:output_type -> project.v1.UpdateProjectResponse
	9,  // 16: project.v1.ProjectService.DeleteProject:output_type -> project.v1.DeleteProjectResponse
	11, // 17: project.v1.ProjectService.GetProjects:output_type -> project.v1.GetProjectsResponse
	13, // 18: project.v1.ProjectService.GetProjectsByCustomer:output_type -> project.v1.GetProjectsByCustomerResponse
